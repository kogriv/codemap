...
- [ ] **M3.2-f1 адаптивный debounce** (XS) — 🆕 (2026-08-28, второй проход по CodeGraph). Плоское окно
      ...
      **Эффект:** ~8.5 с → ~6.5 с, не трогая пол пересборки. Карточка: `research/tools/codegraph.md`.
...
- [ ] **R1-C29 импорт-карта только модульного уровня, а `architecture` называет это свойством** (M) — 🆕
      ...
      **свойство безопасности**; (3) затем резолвить локальные импорты в карту, помечая ленивость (они не
      ...
      `gaps/import_map_module_level_2026-08-28.md` §6–§7. **Сначала (1)+(2), потом (3)** — объявление
      защищает всех будущих потребителей, фикс защищает один релиз.
