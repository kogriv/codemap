...
- [ ] **R1-C21 Плоский layout: краш на namespace-каталоге + молчаливые 0 `imports`-рёбер** 🆕 (2026-08-24,
      **схема не нужна**) — из попытки применить codemap на **втором реальном таргете** (приватная
