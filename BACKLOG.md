...
- [ ] **R1-C45 одна deep-сборка — выборка с известной долей; совет «пересобери» обязан называть N** 🔴
...
- [ ] **R1-C46 имя, определённое дважды в одной области, — находка, а не дубль ребра** 🔴
