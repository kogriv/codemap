...
- [ ] **R1-C30 быстрый тир не резолвит вызовы через функционально-локальный импорт** (S) — 🆕
      (2026-08-28, остаток от R1-C29 / issue #11). R1-C29 закрыл **карту импортов**; резолв **вызовов**
