...
**Статус:** 🟡 частично закрыто — см. баннер обновления ниже  
**Объект анализа:** инструмент `codemap/` (версия 0.0.1, вехи M0+M1 реализованы)  

> **Обновление 2026-07-26 — веха M1.5 (схема `0.2`).** Закрыты «быстрые wins» из §11.1:
...
| ID | Название | Категория | Серьёзность | Веха-fix | Статус |
|----|----------|-----------|--------------|----------|--------|
